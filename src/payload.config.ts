...
export default buildConfig({
  ...
  // Lokaalne arendus käib SQLite failiga (DATABASE_URL=file:...),
  // toodangus saab sama muutujaga MongoDB peale lülitada.
  db: process.env.DATABASE_URL?.startsWith('mongodb')
    ...
    : sqliteAdapter({
        client: {
          url: process.env.DATABASE_URL || 'file:./metsahind.db',
        },
      }),
  collections: [
    {
